...
### Executable Files:
- [Play Store App Review Analysis](Capstone_Project_1_Play_Store_App_Review_Analysis.ipynb) - Includes all functions required for clustering operations.

### Output:
- [Google Colab](Capstone_Project_1_Play_Store_App_Review_Analysis.ipynb) - All the outputs are visible in the provided colab notebook.
...
If you have any feedback, please reach out to us at pranav.balpande@gmail.com
